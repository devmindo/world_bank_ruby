...
describe WorldBank::DataQuery do
  context "lending types" do
    it "accepts a single LendingType as param" do
      ...
      expect(a_get("lendingTypes/IDB/indicators/all?format=json")).to have_been_made
    end
  end
  context "income levels" do
    it "accepts a single IncomeLevels as param" do
      ...
      expect(a_get("incomeLevels/LMC/indicators/all?format=json")).to have_been_made
    end
  end
  context "sources" do
    it "accepts a single Source as param" do
      ...
      expect(a_get("sources/1/indicators/all?format=json")).to have_been_made
    end
  end
  context "country" do
    it "adds countries to the params if given ISO-2 code" do
      ...
      expect(a_get("countries/br/indicators/AB.LND.ARBL.ZS?format=json")).to have_been_made
    end
